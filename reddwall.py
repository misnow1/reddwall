...
class PreferencesDialog(wx.Dialog):
    def __init__(self, app):
        ...
        self.selectCombo = wx.ComboBox(self, value=self.app.settings['select'],
                                       choices=select, style=wx.CB_READONLY)
        ...
        self.subredditCombo = \
            wx.ComboBox(self, value=self.app.settings['subreddit'],
        ...
        self.minVoteSpin = \
            wx.SpinCtrl(self, value=str(self.app.settings['minVote']), min=0,
                        max=10000)
        ...
        self.pastCombo = \
            wx.ComboBox(self, choices=pasts, value=self.app.settings['past'],
        ...
        intervalBox.Add(
            wx.StaticText(self, label='and update the wallpaper every '))
        self.intervalSpin = \
            wx.SpinCtrl(self, value=str(self.app.settings['interval']), min=1)
...
class ReddWall(wx.App):
    ...
    def GetSubmissions(self):
        ...
        #    return
        logger.info("Updating submissions from /r/%s" %
